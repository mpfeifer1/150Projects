...
// Prototypes
bool recognizer         (char palindrome[]);
void decorruptionator   (char palindrome[]);
bool detective          (char palindrome[]);
void cipher             (char palindrome[]);
void decipher           (char palindrome[]);

void toStandard         (char palindrome[]);
void getInput           (char palindrome[]);
